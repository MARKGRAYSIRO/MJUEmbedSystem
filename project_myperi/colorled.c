...
void pwmLedDorm(int dorm) {
    ...
    if (dorm == 1) {         // Slytherin (GREEN)
        pwmSetDuty(1000000, 0);       // set R 0
        pwmSetDuty(0, 1);     // set G 100
        pwmSetDuty(1000000, 2);       // set B 0       
    }
    else if (dorm == 2) {    // Gryffindor (RED)
        pwmSetDuty(0, 0);     // set R 100
        pwmSetDuty(1000000, 1);       // set G 0
        pwmSetDuty(1000000, 2);       // set B 0
    }
    else if (dorm == 3) {    // Ravenclaw (BLUE)
        pwmSetDuty(1000000, 0);       // set R 0
        pwmSetDuty(1000000, 1);       // set G 0
        pwmSetDuty(0, 2);     // set B 100       
    }
        ...
        pwmSetDuty(1000000, 0);   
        pwmSetDuty(1000000, 1);    
        pwmSetDuty(1000000, 2);
    }
